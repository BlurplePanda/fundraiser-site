...
<main>
    ...
    <form name='sort_form' id='sort_form' method='post'>
        ...
        <select id='sortby' name='sortby'>
            ...
            <!-- Options (pre-selected if previously chosen to avoid visual confusion) -->

            <option <?php if (isset($_POST['sortby']) && $_POST['sortby'] == 'PageName ASC') {
                echo "selected ";
            } ?>value='PageName ASC'>Campaign title (A-Z)
            </option>

            <option <?php if (isset($_POST['sortby']) && $_POST['sortby'] == 'PageName DESC') {
                echo "selected ";
            } ?>value='PageName DESC'>Campaign title (Z-A)
            </option>

            <option <?php if (isset($_POST['sortby']) && $_POST['sortby'] == 'FRFName ASC') {
                echo "selected ";
            } ?>value='FRFName ASC'>Fundraiser name (A-Z)
            </option>

            <option <?php if (isset($_POST['sortby']) && $_POST['sortby'] == 'FRFName DESC') {
                echo "selected ";
            } ?>value='FRFName DESC'>Fundraiser name (Z-A)
            </option>

            <option <?php if (isset($_POST['sortby']) && $_POST['sortby'] == 'PageGoal ASC') {
                echo "selected ";
            } ?>value='PageGoal ASC'>Goal size (low to high)
            </option>

            <option <?php if (isset($_POST['sortby']) && $_POST['sortby'] == 'PageGoal DESC') {
                echo "selected ";
            } ?>value='PageGoal DESC'>Goal size (high to low)
            </option>
    ...
    <div class='all-campaigns-container'>
        ...
        if (isset($_POST['sortby'])) {
            ...
            // If user did not choose to sort, make default order be Page Title A-Z
            $sort_by = 'PageName ASC';
        }
        ...
        while ($all_campaigns_record = mysqli_fetch_assoc($all_campaigns_result)) {
            ...
            echo "<p><a href='campaign.php?id=" . $all_campaigns_record['PageID'] . "&fromurl="
                . $_SERVER['REQUEST_URI'] . "'>"; // Link to individual campaign page (encompasses all details)
            echo "<img src='images/" . $all_campaigns_record['PageImage'] . "' alt='' class='allcampaignsimage'><br>";
